...
DB_ENGINE = decouple_config('DB_ENGINE', default='sqlite+aiosqlite')


if DB_ENGINE == 'sqlite+aiosqlite':
    DB_NAME = decouple_config('DB_NAME', default='db.sqlite')
    DATABASE_URL = f"{DB_ENGINE}:///{DB_NAME}"
else:
    DB_ENGINE = decouple_config('DB_ENGINE', default='postgresql+asyncpg')
